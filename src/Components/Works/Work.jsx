  ...
  return (
    <div className="Work-Container">
      ...
      <div className="Cards">
         ...
         <Card src={"./images/Works/hindi.png"} gitHub={"https://github.com/Abhinavrajsrivastav/React-Projects/tree/master/Musics/hinlish"} name={"HindLish"} about={"Music player - Hindi and English songs"} link={"https://healsync.onrender.com/"} toolImg={["react.png"]}/>
      </div>
