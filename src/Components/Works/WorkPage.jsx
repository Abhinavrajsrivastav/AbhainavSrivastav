    ...
    <div className="Page-Work-Container">
      <div className="Page-Work">
        <div className="Page-Work-Head">
          ...
          <span className="Page-Text-description">Here are few projects I've worked on recently.</span>
        </div>

        <div className="Page-Cards">
          <CardsPage src={"./images/Works/educome.png"} gitHub={"https://github.com/Abhinavrajsrivastav/pacifics-path"} name={"Educome"} about={"A platform for engineers. Google Gemini Competition - 2024"} link={"https://abhinavrajsrivastav.github.io/pacifics-path/"} toolImg={["react.png"]} tech={["React", "GCP", "Gemini 1.5", "Firebase","MySql"]}  className="animated" />
          ...
          <CardsPage src={"./images/Works/image.png"} gitHub={""} name={"Customer Transactions Dashboard"} about={"A Customer Transaction Report Dashboard created with PowerBi."} link={"https://abes365-my.sharepoint.com/:u:/g/personal/abhinav_21b1531174_abes_ac_in/EUsuVCtNi61Hh9FCol3AU50BC8Ng9pPerXvQNn-kL9Vy7A?e=UkclRJ"} toolImg={["powerbi.png"]} tech={["Power Bi"]} className="animated" />
