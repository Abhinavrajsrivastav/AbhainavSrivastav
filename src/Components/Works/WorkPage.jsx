    ...
    <div className="Page-Work-Container">
      <div className="Page-Work">
        ...
        <div className="Page-Cards">
          ...
          <CardsPage src={"./images/Works/EduCloud.png"} gitHub={"https://github.com/Abhinavrajsrivastav/cloud-octo-eureka"} name={"EduCloud"} about={"A Cloud Based Solution For Your All Works."} link={""} toolImg={["react.png", "leaf.png"]} tech={["React","Spring Boot"]}/>
