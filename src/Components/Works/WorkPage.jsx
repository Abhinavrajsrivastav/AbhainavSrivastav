  ...
  return (
    <div className="Page-Work-Container">
      ...
      <div className="Page-Cards">
        ...
        <CardsPage src={"./images/Works/GeminiAi.png"} gitHub={"https://github.com/Abhinavrajsrivastav/SpringBootProjects/tree/main/OpenAi"} name={"Gemini Ai Clone"} about={"It is a Gemini UI and Functionality text-text response clone. An Spring Ai and Open Source project, help programmers in their code to debug, write codes and will answer effectively."} link={"https://clone-gemini.vercel.app/"} toolImg={["chat-gpt.png","react.png","leaf.png"]}/>
